...
def generate_toc(html_content):
    ...
    for item in toc_structure:
        toc_html += f"<li style='font-size: {20-(item['level']-2)}px; margin-left: {item['level']*20}px;'><a href='#{item['id']}'>{item['text']}</a></li>"

    #attributions to the creator of the ToC
    toc_html += "<li style='margin-left: 2px;'><a href='https://mathiasschjoedt-bavngaard.github.io/'>Creator Of ToC</a></li>"
